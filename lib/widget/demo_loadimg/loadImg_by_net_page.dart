        ...
        children: <Widget>[
          new Padding(
            ...
            child: new RaisedButton(
              child: new Text('加载普通图片'),
              onPressed: _loadNormalImg,
            ),
          ),
          new Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            child: new RaisedButton(
              child: new Text('加载gif图片'),
              onPressed: _loadGifImg,
            ),
          ),
          new Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            child: new RaisedButton(
              child: new Text('加载缓存图片'),
              onPressed: _loadImgWithCache,
            ),
          ),
          new Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            child: new RaisedButton(
              child: new Text('淡入动画加载图片'),
              onPressed: _loadImgWithFade,
            )
          ),
