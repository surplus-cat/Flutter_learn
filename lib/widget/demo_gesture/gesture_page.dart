        ...
        children: <Widget>[
          new Padding(
            ...
            child: new RaisedButton(
              ...
              onPressed: () {
                _showSnackBar("这是一个 RaisedButton 点击事件,onPressed处理");
              },
            ),
          ),
          new Padding(
            ...
            child: new GestureDetector(
              onTap: () {
                _showSnackBar("这是一个GestureDetector监听的onTap事件");
              },
          ...
          new Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            child: new Text(tapEvent, style: Theme.of(context).textTheme.display1,),
          ),
          new Padding(
            padding: const EdgeInsets.only(left: 10.0, top: 10.0, right: 10.0),
            child: new GestureDetector(
          ...
          new Padding(
            ...
            child: new InkWell(
              ...
              onTap: () {
                setState(() {
                  _showSnackBar("这是一个InkWell监听的onTap事件");
                });
              },
