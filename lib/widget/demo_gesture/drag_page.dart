...
class DragModel {
  ...
  final Color itemBgColors;

  DragModel(this.itemPos, this.itemName, this.itemBgColors);
}
      ...
      body: new Container(
        child: new Stack(
          children: <Widget>[
            ...
            new DragItem(new DragModel(Offset(0.0, 1 * drag_item_height), '橙', Colors.orange)),
            new DragItem(new DragModel(Offset(0.0, 2 * drag_item_height), '黄', Colors.yellow)),
            new DragItem(new DragModel(Offset(0.0, 3 * drag_item_height), '绿', Colors.green)),
            new DragItem(new DragModel(Offset(0.0, 4 * drag_item_height), '青', Colors.indigoAccent)),
            new DragItem(new DragModel(Offset(0.0, 5 * drag_item_height), '蓝', Colors.blue)),
            new DragItem(new DragModel(Offset(0.0, 6 * drag_item_height), '紫', Colors.purple)),
            new DragDestination(),
          ]
        ),
      ),
    ...
    return Positioned(
      ...
      child: DragTarget(
        onAccept: (DragModel model) {
          if (model.itemBgColors == _curRandomColor) {
            _score++;
          }
        },
        builder: (
          BuildContext context,
          List<dynamic> acceped,
    ...
    return Positioned(
      ...
      child: Draggable(
        ...
        child: Container(
          ...
          color: widget.dragModel.itemBgColors,
          child: Center(
            child: Text(
        ...
        feedback: Container(
          width: drag_item_height,
          height: drag_item_height,
          color: widget.dragModel.itemBgColors.withOpacity(0.5),
          child: Text(
            widget.dragModel.itemName,
            style: TextStyle(
              color: Colors.white,
