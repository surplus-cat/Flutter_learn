...
class StudyLocalizationsDelegate extends LocalizationsDelegate<StudyLocalizations> {
  ...
  static StudyLocalizationsDelegate delegate = const StudyLocalizationsDelegate();
}