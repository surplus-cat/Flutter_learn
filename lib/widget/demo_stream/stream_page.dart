...
import 'package:flutter_learn/model/base_model.dart';
...
class _StreamPageState extends State<StreamPage> {
  ...
  _loadData() async {
    _api.getSearchResult('all').asStream().map((value) => (!value.error &&
      null != value.results && value.results.length > 0) ? value.results : null)
